<template>
  <div>
    <title-bar :title-stack="['Admin', 'Products']"/>
    <hero-bar>
      Products
      <router-link to="/products/new" class="button" slot="right">
        New
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <card-component class="has-table has-mobile-sort-spaced" title="Products" icon="account-multiple">
        ...
        <b-table
          ...
          <b-table-column label="Quantity" field="quantity" sortable v-slot="props">
            {{ props.row.quantity }}
          </b-table-column>
...
export default {
  ...
  methods: {
    ...
    trashConfirm () {
      ...
      if (this.trashObject) {
        method = 'delete'
        url = `/products/${this.trashObject.id}/destroy`
