<template>
  <div>
    ...
    <hero-bar>
      {{ heroTitle }}
      <router-link slot="right" to="/products/index" class="button">
        Products
      </router-link>
    </hero-bar>
      ...
      <tiles>
        <card-component :title="formCardTitle" icon="tag" class="tile is-child">
          <form @submit.prevent="submit">
            ...
            <hr>
            <b-field label="Name" message="Product name" horizontal>
              <b-input placeholder="" v-model="form.name" required />
            </b-field>
            <b-field label="Description" message="Product description" horizontal>
              <b-input placeholder="" v-model="form.description" required />
            </b-field>
            <b-field label="Quantity" message="Product's quantity" horizontal>
              <b-input placeholder="" v-model="form.quantity" required />
            </b-field>
            <hr>
            <b-field horizontal>
        ...
        <card-component v-if="isProfileExists" title="Product Details" icon="tag" class="tile is-child">
          <b-field label="Name">
          ...
          <b-field label="Quantity">
            <b-input :value="item.quantity" custom-class="is-static" readonly/>
          </b-field>
        </card-component>
      </tiles>
    </section>
    ...
    submit () {
      ...
      axios({
        ...
        if (!this.id && r.data.data.id) {
          this.$router.push({name: 'products.edit', params: {id: r.data.data.id}})
