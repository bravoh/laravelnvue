<template>
  <div>
    <title-bar :title-stack="['Admin', 'Suppliers']"/>
    <hero-bar>
      Suppliers
      <router-link to="/suppliers/new" class="button" slot="right">
        New
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <card-component class="has-table has-mobile-sort-spaced" title="Suppliers" icon="account-multiple">
        ...
        <b-table
          ...
          <b-table-column custom-key="actions" class="is-actions-cell" v-slot="props">
            <div class="buttons is-right">
              <router-link :to="{name:'suppliers.edit', params: {id: props.row.id}}" class="button is-small is-primary">
...
export default {
  ...
  methods: {
    ...
    trashConfirm () {
      ...
      if (this.trashObject) {
        method = 'delete'
        url = `/suppliers/${this.trashObject.id}/destroy`
